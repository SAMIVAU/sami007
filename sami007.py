...
jalan("\x1b[1;91m`●❯───────❮●")
jalan('\x1b[1;96m●❯───────❮●')
print '\x1b[1;90m        PUBLIC ID CRACKER BY \x1b[1;96mSAMI VAU'
print '\x1b[1;97m--------------------------------------------------'
print '\x1b[1;95m'
print ' AUTHOR     : MD. SUHANUR RAHMAN SAMI '
print ' FACEBOOK   : FACEBOOK.COM/THE.NORMAL.USER.404'
print' লা-ইলাহা ইল্লাল্লাহু মুহাম্মাদুর রাসূলুল্লাহ।'
print '\x1b[1;32m'
print '--------------------------------------------------'
jalan('\x1b[1;97m')
print '\n\x1b[1;96mFIRST OF ALL FOLLOW MY PAGE'
time.sleep(1)
os.system('xdg-open https://www.facebook.com/THE.NORMAL.USER.404')
time.sleep(1)
...
def menu():
    ...
    print '\x1b[1;32;40m[2] \x1b[1;33;40m\xe2\x95\x90\xe2\x95\x90Update Fucking'
...
def pilih_super():
    ...
    jalan('                    \x1b[1;97mFucking start , Please Wait...')
